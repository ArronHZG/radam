...
writer = SummaryWriter(logdir='./run/log_cifa10/')
...
def main():
    ...
    trainset = dataloader(root=f'~/dataset/{args.dataset}', train=True, download=True, transform=transform_train)
    trainloader = data.DataLoader(trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers)

    testset = dataloader(root=f'~/dataset/{args.dataset}', train=False, download=False, transform=transform_test)
